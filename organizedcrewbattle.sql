...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 03 oct. 2024 à 11:42
...
--
ALTER TABLE `checkin`
  MODIFY `id_checkin` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `verif_report`
  MODIFY `id_verifReport` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
